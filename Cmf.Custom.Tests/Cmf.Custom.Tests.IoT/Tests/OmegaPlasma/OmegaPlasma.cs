...
{
    [TestClass]
    public class OmegaPlasma : CommonTests
    {
        private const string resourceName = "5FICP1";
        ...
        public const string readerResourceName = "5FICP1.RFID";
        ...
        /// </summary>
        [TestMethod]
        public void OmegaPlasma_FullProcessRecipeExists()
        {
        ...
        /// </summary>
        [TestMethod]
        public void OmegaPlasma_SameRecipeOnlineLocal()
        {
            base.MESScenario = InitializeMaterialScenario(resourceName, flowName, stepName, numberOfWafersPerLot, false);
        ...
        /// </summary>
        [TestMethod]
        public void OmegaPlasma_RecipeDoesNotExist()
        {
            base.MESScenario = InitializeMaterialScenario(resourceName, flowName, stepName, numberOfWafersPerLot, false);
            base.MESScenario = InitializeMaterialScenario(resourceName, flowName, stepName, numberOfWafersPerLot, false);
        ...
        /// </summary>
        [TestMethod]
        public void OmegaPlasma_AlarmDataCollection()
        {
