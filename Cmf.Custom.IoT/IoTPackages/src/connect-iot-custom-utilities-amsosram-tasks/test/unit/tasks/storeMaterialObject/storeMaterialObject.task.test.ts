...
import {
    StoreMaterialObjectTask,
    StoreMaterialObjectSettings
} from "../../../../src/tasks/storeMaterialObject/storeMaterialObject.task";
import StoreMaterialObjectTaskModule from "../../../../src/tasks/storeMaterialObject/index";

describe("StoreMaterialObjectTaskModule Task tests", () => {


    // Optional: See container handling under StoreMaterialObjectTaskModule
    // let dataStoreMock: DataStoreMock;
    beforeEach(() => {
        // dataStoreMock = new DataStoreMock();
    });

    const StoreMaterialObjectTestFactory = (  settings: StoreMaterialObjectSettings | undefined,
                                            trigger: Function,
                                            validate: Function): void => {

        const taskDefinition = {
            class: StoreMaterialObjectTaskModule,
            id: "0",
            settings: settings || <StoreMaterialObjectSettings>{
                message: ""
            }
        };
     ...
     *    0 - StoreMaterialObjectTestFactory
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the StoreMaterialObjectTestFactory task
     * All Outputs of StoreMaterialObjectTestFactory Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the StoreMaterialObjectTestFactory to be activated
     * and check the changes to see if the StoreMaterialObjectTestFactory task sent you the correct values
     *
    ...
    it("should get success when activated", (done) => {
        StoreMaterialObjectTestFactory(undefined,
