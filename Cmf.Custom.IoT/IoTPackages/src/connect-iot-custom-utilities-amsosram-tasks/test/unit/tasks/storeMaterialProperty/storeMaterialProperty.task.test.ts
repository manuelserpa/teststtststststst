...
import {
    StoreMaterialPropertyTask,
    StoreMaterialPropertySettings
} from "../../../../src/tasks/storeMaterialProperty/storeMaterialProperty.task";
import StoreMaterialTaskModule from "../../../../src/tasks/storeMaterialProperty/index";

describe("StoreMaterialTaskModule Task tests", () => {


    // Optional: See container handling under storeMaterialTestFactory
    // let dataStoreMock: DataStoreMock;
    beforeEach(() => {
        // dataStoreMock = new DataStoreMock();
    });

    const storeMaterialTestFactory = (  settings: StoreMaterialPropertySettings | undefined,
                                            trigger: Function,
                                            validate: Function): void => {

        const taskDefinition = {
            class: StoreMaterialTaskModule,
            id: "0",
            settings: settings || <StoreMaterialPropertySettings>{
           //     message: ""
            }
        };
     ...
     *    0 - storeMaterialTestFactory Task
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the storeMaterialTestFactory task
     * All Outputs of storeMaterialTestFactory Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the storeMaterialTestFactory to be activated
     * and check the changes to see if the storeMaterialTestFactory task sent you the correct values
     *
    ...
    it("should get success when activated", (done) => {
        storeMaterialTestFactory(undefined,
