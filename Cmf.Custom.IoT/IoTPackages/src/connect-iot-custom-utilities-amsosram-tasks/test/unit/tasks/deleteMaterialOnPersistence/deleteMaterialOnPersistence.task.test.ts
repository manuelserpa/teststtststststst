...
import {
    DeleteMaterialOnPersistenceTask,
    DeleteMaterialOnPersistenceSettings
} from "../../../../src/tasks/deleteMaterialOnPersistence/deleteMaterialOnPersistence.task";
import CheckAutomationModesTaskModule from "../../../../src/tasks/deleteMaterialOnPersistence/index";

describe("DeleteMaterialOnPersistence Task tests", () => {
    ...
    // Optional: See container handling under checkAutomationModesTestFactory
    // let dataStoreMock: DataStoreMock;
    beforeEach(() => {
        // dataStoreMock = new DataStoreMock();
    });

    const checkAutomationModesTestFactory = (  settings: DeleteMaterialOnPersistenceSettings | undefined,
                                            trigger: Function,
                                            validate: Function): void => {

        const taskDefinition = {
            class: CheckAutomationModesTaskModule,
            id: "0",
            settings: settings || <DeleteMaterialOnPersistenceSettings>{
                message: ""
            }
        };
     ...
     *    0 - CheckAutomationModes Task
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the CheckAutomationModes task
     * All Outputs of CheckAutomationModes Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the CheckAutomationModes to be activated
     * and check the changes to see if the CheckAutomationModes task sent you the correct values
     *
    ...
    it("should get success when activated", (done) => {
        checkAutomationModesTestFactory(undefined,
