...
import { CustomPropertyPollingSettings, CustomPropertyPollingOutputSettings, CustomPropertyPollingOutputType } from "./customPropertyPolling.task";

@Task.Designer.TaskDesigner()
export class CustomPropertyPollingDesigner implements Task.Designer.TaskDesignerInstance, CustomPropertyPollingSettings {
    ...
    public async onGetOutputs(outputs: Task.TaskOutputs): Promise<Task.TaskOutputs> {
        if (this._outputs) {
            for (const output of this._outputs) {
                ...
                if (output.outputType === CustomPropertyPollingOutputType.RawValue) {
