...
import * as UpdateMaterialStateTask from "./updateMaterialState.task";
...
/** i18n */
import i18n from "./i18n/updateMaterialState.settings.default";
...
/** Constants */
export interface UpdateMaterialStateTaskSettings extends
UpdateMaterialStateTask.UpdateMaterialStateSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-updateMaterialState-settings",
    templateUrl: "updateMaterialState.settings.html",
    styleUrls: ["./updateMaterialState.settings.css"],
    assign: {
        i18n: i18n,
        MaterialStateEnum: MaterialStateEnum,
        LotProcessDefinitionEnum: LotProcessDefinitionEnum,
    }
})
export class UpdateMaterialStateSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: UpdateMaterialStateTaskSettings;
    private _taskInstance: UpdateMaterialStateTask.UpdateMaterialStateTask;
     ...
     */
    public onBeforeSave(settings: UpdateMaterialStateTask.UpdateMaterialStateSettings):
            UpdateMaterialStateTask.UpdateMaterialStateSettings {
...
@Module({
    ...
    declarations: [UpdateMaterialStateSettings],
    defaultRoute: UpdateMaterialStateSettings
})
export class UpdateMaterialStateSettingsModule { }
