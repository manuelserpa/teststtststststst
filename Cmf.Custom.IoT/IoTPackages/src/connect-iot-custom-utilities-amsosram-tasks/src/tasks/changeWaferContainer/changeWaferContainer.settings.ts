...
import * as ChangeWaferContainerTask from "./changeWaferContainer.task";
...
/** i18n */
import i18n from "./i18n/changeWaferContainer.settings.default";

/** Constants */
export interface ChangeWaferContainerTaskSettings extends ChangeWaferContainerTask.ChangeWaferContainerSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-changeWaferContainer-settings",
    templateUrl: "changeWaferContainer.settings.html",
    styleUrls: ["./changeWaferContainer.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class ChangeWaferContainerSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: ChangeWaferContainerTaskSettings;
    private _taskInstance: ChangeWaferContainerTask.ChangeWaferContainerTask;
    ...
    public ngOnInit(): void {
        ...
        Object.assign(this.settings, ChangeWaferContainerTask.SETTINGS_DEFAULTS, currentSettings);
     ...
     */
    public onBeforeSave(settings: ChangeWaferContainerTask.ChangeWaferContainerSettings):
            ChangeWaferContainerTask.ChangeWaferContainerSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [ChangeWaferContainerSettings],
    defaultRoute: ChangeWaferContainerSettings
})
export class ChangeWaferContainerSettingsModule { }
