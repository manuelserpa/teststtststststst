...
import { ChangeWaferContainerSettings } from "./changeWaferContainer.task";

@Task.Designer.TaskDesigner()
export class ChangeWaferContainerDesigner implements Task.Designer.TaskDesignerInstance, ChangeWaferContainerSettings {
