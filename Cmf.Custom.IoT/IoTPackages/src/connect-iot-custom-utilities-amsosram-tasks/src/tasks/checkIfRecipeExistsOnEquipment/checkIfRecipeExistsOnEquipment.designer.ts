...
import { CheckIfRecipeExistsOnEquipmentSettings } from "./checkIfRecipeExistsOnEquipment.task";

@Task.Designer.TaskDesigner()
export class CheckIfRecipeExistsOnEquipmentDesigner implements Task.Designer.TaskDesignerInstance, CheckIfRecipeExistsOnEquipmentSettings {
