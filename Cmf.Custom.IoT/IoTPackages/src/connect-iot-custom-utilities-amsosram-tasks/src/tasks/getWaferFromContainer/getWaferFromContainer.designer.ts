...
import { GetWaferFromContainerSettings } from "./getWaferFromContainer.task";

@Task.Designer.TaskDesigner()
export class GetWaferFromContainerDesigner implements Task.Designer.TaskDesignerInstance, GetWaferFromContainerSettings {
