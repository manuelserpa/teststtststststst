...
import * as GetWaferFromContainerTask from "./getWaferFromContainer.task";
...
/** i18n */
import i18n from "./i18n/getWaferFromContainer.settings.default";

/** Constants */
export interface GetWaferFromContainerTaskSettings extends GetWaferFromContainerTask.GetWaferFromContainerSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-getWaferFromContainer-settings",
    templateUrl: "getWaferFromContainer.settings.html",
    styleUrls: ["./getWaferFromContainer.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class GetWaferFromContainerSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: GetWaferFromContainerTaskSettings;
    private _taskInstance: GetWaferFromContainerTask.GetWaferFromContainerTask;
    ...
    public ngOnInit(): void {
        ...
        Object.assign(this.settings, GetWaferFromContainerTask.SETTINGS_DEFAULTS, currentSettings);
     ...
     */
    public onBeforeSave(settings: GetWaferFromContainerTask.GetWaferFromContainerSettings):
            GetWaferFromContainerTask.GetWaferFromContainerSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [GetWaferFromContainerSettings],
    defaultRoute: GetWaferFromContainerSettings
})
export class GetWaferFromContainerSettingsModule { }
