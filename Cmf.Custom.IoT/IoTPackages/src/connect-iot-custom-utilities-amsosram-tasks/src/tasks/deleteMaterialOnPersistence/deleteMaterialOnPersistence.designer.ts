...
import { DeleteMaterialOnPersistenceSettings } from "./deleteMaterialOnPersistence.task";

@Task.Designer.TaskDesigner()
export class DeleteMaterialOnPersistenceDesigner implements Task.Designer.TaskDesignerInstance, DeleteMaterialOnPersistenceSettings {
