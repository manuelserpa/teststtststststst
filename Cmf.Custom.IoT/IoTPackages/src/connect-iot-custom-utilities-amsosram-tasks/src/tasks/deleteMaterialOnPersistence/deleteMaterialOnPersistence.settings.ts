...
import * as DeleteMaterialOnPersistenceTask from "./deleteMaterialOnPersistence.task";
...
/** i18n */
import i18n from "./i18n/deleteMaterialOnPersistence.settings.default";

/** Constants */
export interface DeleteMaterialOnPersistenceTaskSettings extends DeleteMaterialOnPersistenceTask.DeleteMaterialOnPersistenceSettings,
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-deleteMaterialOnPersistence-settings",
    templateUrl: "deleteMaterialOnPersistence.settings.html",
    styleUrls: ["./deleteMaterialOnPersistence.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class DeleteMaterialOnPersistenceSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: DeleteMaterialOnPersistenceTaskSettings;
    private _taskInstance: DeleteMaterialOnPersistenceTask.DeleteMaterialOnPersistenceTask;
     ...
     */
    public onBeforeSave(settings: DeleteMaterialOnPersistenceTask.DeleteMaterialOnPersistenceSettings):
            DeleteMaterialOnPersistenceTask.DeleteMaterialOnPersistenceSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [DeleteMaterialOnPersistenceSettings],
    defaultRoute: DeleteMaterialOnPersistenceSettings
})
export class DeleteMaterialOnPersistenceSettingsModule { }
