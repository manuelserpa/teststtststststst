...
import * as CustomReadIdTask from "./customReadId.task";
/** Angular */
...
/** i18n */
import i18n from "./i18n/customReadId.settings.default";
...
/** Constants */
export interface CustomReadIdTaskSettings extends
    CustomReadIdTask.CustomReadIdSettings, WorkflowModel.TaskDefinitionSettings { }
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-customReadId-settings",
    templateUrl: "customReadId.settings.html",
    assign: {
        i18n: i18n
    }
})
export class CustomReadIdSettings extends TaskSettingsBase implements ng.OnInit {

    /**
     * Task settings
     */
    public settings: CustomReadIdTaskSettings;

    /** helper to access main task (for defaults loading) */
    private _taskInstance: CustomReadIdTask.CustomReadIdTask;
...
@Module({
    ...
    declarations: [CustomReadIdSettings],
    defaultRoute: CustomReadIdSettings
})

export class CustomReadIdSettingsModule { }
