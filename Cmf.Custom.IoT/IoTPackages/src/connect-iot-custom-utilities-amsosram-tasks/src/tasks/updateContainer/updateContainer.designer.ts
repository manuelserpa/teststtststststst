...
import { UpdateContainerSettings } from "./updateContainer.task";

@Task.Designer.TaskDesigner()
export class UpdateContainerDesigner implements Task.Designer.TaskDesignerInstance, UpdateContainerSettings {
