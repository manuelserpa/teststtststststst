...
import { RetrieveSyncJobSettings } from "./retrieveSyncJob.task";
...
export class RetrieveSyncJobDesigner implements Task.Designer.TaskDesignerInstance, RetrieveSyncJobSettings {
