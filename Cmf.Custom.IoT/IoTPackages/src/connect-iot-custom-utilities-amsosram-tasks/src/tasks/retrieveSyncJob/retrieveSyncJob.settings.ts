...
import * as RetrieveSyncJobTask from "./retrieveSyncJob.task";
...
/** i18n */
import i18n from "./i18n/retrieveSyncJob.settings.default";
...
/** Constants */
export interface RetrieveSyncJobTaskSettings extends
RetrieveSyncJobTask.RetrieveSyncJobSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-retrieveSyncJob-settings",
    templateUrl: "retrieveSyncJob.settings.html",
    styleUrls: ["./retrieveSyncJob.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class RetrieveSyncJobSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: RetrieveSyncJobTaskSettings;
    private _taskInstance: RetrieveSyncJobTask.RetrieveSyncJobTask;
     ...
     */
    public onBeforeSave(settings: RetrieveSyncJobTask.RetrieveSyncJobSettings):
            RetrieveSyncJobTask.RetrieveSyncJobSettings {
...
@Module({
    ...
    declarations: [RetrieveSyncJobSettings],
    defaultRoute: RetrieveSyncJobSettings
})
export class RetrieveSyncJobSettingsModule { }
