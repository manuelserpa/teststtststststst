...
import { DeleteContainerSettings } from "./deleteContainer.task";

@Task.Designer.TaskDesigner()
export class DeleteContainerDesigner implements Task.Designer.TaskDesignerInstance, DeleteContainerSettings {
