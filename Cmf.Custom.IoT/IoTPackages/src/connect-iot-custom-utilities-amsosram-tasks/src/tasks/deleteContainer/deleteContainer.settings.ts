...
import * as DeleteContainerTask from "./deleteContainer.task";
...
/** i18n */
import i18n from "./i18n/deleteContainer.settings.default";

/** Constants */
export interface DeleteContainerTaskSettings extends DeleteContainerTask.DeleteContainerSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-deleteContainer-settings",
    templateUrl: "deleteContainer.settings.html",
    styleUrls: ["./deleteContainer.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class DeleteContainerSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: DeleteContainerTaskSettings;
    private _taskInstance: DeleteContainerTask.DeleteContainerTask;
    ...
    public ngOnInit(): void {
        ...
        Object.assign(this.settings, DeleteContainerTask.SETTINGS_DEFAULTS, currentSettings);
     ...
     */
    public onBeforeSave(settings: DeleteContainerTask.DeleteContainerSettings):
            DeleteContainerTask.DeleteContainerSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [DeleteContainerSettings],
    defaultRoute: DeleteContainerSettings
})
export class DeleteContainerSettingsModule { }
