...
import { RetrieveSubMaterialPropertyOutputSettings } from "../retrieveSubMaterialProperty.task";
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-retrieveSubMaterialProperty-settings-output",
...
export class Outputs extends CoreComponent implements ng.OnInit, ng.OnChanges, OnValidate {
     ...
     */
    public data: RetrieveSubMaterialPropertyOutputSettings[] = null;

    /**
     * On Data Change emitter.
     */
    public dataChange: ng.EventEmitter<RetrieveSubMaterialPropertyOutputSettings[]> = new ng.EventEmitter<RetrieveSubMaterialPropertyOutputSettings[]>();
    ...
    private buildColumnViewModel(data: RetrieveSubMaterialPropertyOutputSettings[]): void {
    ...
    private buildColumnViewChildModel(data: RetrieveSubMaterialPropertyOutputSettings): ColumnViewModel.ColumnViewLeaf {
        return {
    ...
    private validateRow(context: OnValidateArgs, data: RetrieveSubMaterialPropertyOutputSettings): boolean {
     ...
     */
    public getLinks(): RetrieveSubMaterialPropertyOutputSettings[] {
        let rt: RetrieveSubMaterialPropertyOutputSettings[] = [];
