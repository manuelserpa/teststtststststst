...
import { GetContainerSettings } from "./getContainer.task";

@Task.Designer.TaskDesigner()
export class GetContainerDesigner implements Task.Designer.TaskDesignerInstance, GetContainerSettings {
