...
import i18n from "./i18n/getContainer.default";
import { ContainerProcessHandler } from "../../persistence/implementation/containerDataHandler";

/** Default values for settings */
export const SETTINGS_DEFAULTS: GetContainerSettings = {
    inputs: [],
    outputs: [],
    message: ""
}
...
@Task.Task({
    ...
    outputs: {
        ...
        slots: Task.TaskValueType.Object,
        slotMap: Task.TaskValueType.Object,
        success: Task.OUTPUT_SUCCESS,
        error: Task.OUTPUT_ERROR
    }
})
export class GetContainerTask implements Task.TaskInstance, GetContainerSettings {
    ...
    /** Slots Output */
    public slots: Task.Output<Object> = new Task.Output<Object>();
    /** Slot Map Output*/
    public slotMap: Task.Output<Object> = new Task.Output<Object>();
    ...
    async onChanges(changes: Task.Changes): Promise<void> {
        if (changes["activate"]) {
            ...
            try {
                ...
                this.slots.emit(container.Slots);
                this.slotMap.emit(container.SlotMap);
...
// Add settings here
/** GetContainer Settings object */
export interface GetContainerSettings extends TaskDefaultSettings {
    message: string;
}
