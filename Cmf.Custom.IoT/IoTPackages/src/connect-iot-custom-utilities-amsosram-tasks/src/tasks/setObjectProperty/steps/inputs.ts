...
import { SetObjectPropertyInputSettings} from "../setObjectProperty.task";
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-setObjectProperty-settings-input",
...
export class Inputs extends CoreComponent implements ng.OnInit, ng.OnChanges {
    ...
    public data: SetObjectPropertyInputSettings[] = null;

    /* On Data Change emitter.*/
    public dataChange: ng.EventEmitter<SetObjectPropertyInputSettings[]> = new ng.EventEmitter<SetObjectPropertyInputSettings[]>();
    ...
    private buildColumnViewModel(data: SetObjectPropertyInputSettings[]): void {
        this._model = {
            rootNode: {
                id: "root",
                name: "links",
    ...
    private buildColumnViewChildModel(data: SetObjectPropertyInputSettings): ColumnViewModel.ColumnViewLeaf {
        return {
    ...
    private validateRow(context: OnValidateArgs, data: SetObjectPropertyInputSettings): boolean {
     ...
     */
    public getLinks(): SetObjectPropertyInputSettings[] {
        let rt: SetObjectPropertyInputSettings[] = [];
