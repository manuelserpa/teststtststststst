...
import { StoreMaterialObjectSettings } from "./storeMaterialObject.task";

@Task.Designer.TaskDesigner()
export class StoreMaterialObjectDesigner implements Task.Designer.TaskDesignerInstance, StoreMaterialObjectSettings {
    [key: string]: any;
