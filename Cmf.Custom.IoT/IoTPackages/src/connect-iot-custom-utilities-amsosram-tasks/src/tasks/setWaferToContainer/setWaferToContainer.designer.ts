...
import { SetWaferToContainerSettings } from "./setWaferToContainer.task";

@Task.Designer.TaskDesigner()
export class SetWaferToContainerDesigner implements Task.Designer.TaskDesignerInstance, SetWaferToContainerSettings {
