...
import * as CustomSendAdHocEquipmentRequestTask from "./customSendAdHocEquipmentRequest.task";
/** Angular */
...
/** i18n */
import i18n from "./i18n/customSendAdHocEquipmentRequest.settings.default";
...
/** Constants */
export interface CustomSendAdHocEquipmentRequestTaskSettings extends
CustomSendAdHocEquipmentRequestTask.CustomSendAdHocEquipmentRequestSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-customSendAdHocEquipmentRequest-settings",
    templateUrl: "customSendAdHocEquipmentRequest.settings.html",
    assign: {
        i18n: i18n
    }
})
export class CustomSendAdHocEquipmentRequestSettings extends TaskSettingsBase implements ng.OnInit {

    /**
     * Task settings
     */
    public settings: CustomSendAdHocEquipmentRequestTaskSettings;

    /** helper to access main task (for defaults loading) */
    private _taskInstance: CustomSendAdHocEquipmentRequestTask.CustomSendAdHocEquipmentRequestTask;
...
@Module({
    ...
    declarations: [CustomSendAdHocEquipmentRequestSettings],
    defaultRoute: CustomSendAdHocEquipmentRequestSettings
})

export class CustomSendAdHocEquipmentRequestSettingsModule { }
