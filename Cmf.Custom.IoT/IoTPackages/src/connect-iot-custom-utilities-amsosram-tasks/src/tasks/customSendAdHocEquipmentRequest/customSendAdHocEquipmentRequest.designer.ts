...
import { CustomSendAdHocEquipmentRequestTask, CustomSendAdHocEquipmentRequestSettings} from "./customSendAdHocEquipmentRequest.task";

@Task.Designer.TaskDesigner()
export class CustomSendAdHocEquipmentRequestDesigner implements Task.Designer.TaskDesignerInstance, CustomSendAdHocEquipmentRequestSettings {
