...
import * as CustomMaterialTransferStatusRequestTask from "./customMaterialTransferStatusRequest.task";
...
/** i18n */
import i18n from "./i18n/customMaterialTransferStatusRequest.settings.default";
...
/** Constants */
export interface CustomMaterialTransferStatusRequestTaskSettings extends
CustomMaterialTransferStatusRequestTask.CustomMaterialTransferStatusRequestSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-customMaterialTransferStatusRequest-settings",
    templateUrl: "customMaterialTransferStatusRequest.settings.html",
    assign: {
        i18n: i18n,
    }
})
export class CustomMaterialTransferStatusRequestSettings extends TaskSettingsBase implements ng.OnInit {

    /**
     * Task settings
     */
    public settings: CustomMaterialTransferStatusRequestTaskSettings;

    /** helper to access main task (for defaults loading) */
    private _taskInstance: CustomMaterialTransferStatusRequestTask.CustomMaterialTransferStatusRequestTask;
...
@Module({
    ...
    declarations: [CustomMaterialTransferStatusRequestSettings],
    defaultRoute: CustomMaterialTransferStatusRequestSettings
})

export class CustomMaterialTransferStatusRequestSettingsModule { }
