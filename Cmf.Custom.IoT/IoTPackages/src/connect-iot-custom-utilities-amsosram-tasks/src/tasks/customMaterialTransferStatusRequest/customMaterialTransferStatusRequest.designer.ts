...
import { CustomMaterialTransferStatusRequestTask, CustomMaterialTransferStatusRequestSettings } from "./customMaterialTransferStatusRequest.task";

@Task.Designer.TaskDesigner()
export class CustomMaterialTransferStatusRequestDesigner implements Task.Designer.TaskDesignerInstance, CustomMaterialTransferStatusRequestSettings {
