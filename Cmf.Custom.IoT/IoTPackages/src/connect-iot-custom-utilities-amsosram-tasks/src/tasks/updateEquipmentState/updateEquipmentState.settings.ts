...
import * as UpdateEquipmentStateTask from "./updateEquipmentState.task";
...
/** i18n */
import i18n from "./i18n/updateEquipmentState.settings.default";

/** Constants */
export interface UpdateEquipmentStateTaskSettings extends UpdateEquipmentStateTask.UpdateEquipmentStateSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-updateEquipmentState-settings",
    templateUrl: "updateEquipmentState.settings.html",
    styleUrls: ["./updateEquipmentState.settings.css"],
    assign: {
        i18n: i18n,
        EquipmentStateEnum: CustomEquipmentStateEnum
    }
})
export class UpdateEquipmentStateSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: UpdateEquipmentStateTaskSettings;
    private _taskInstance: UpdateEquipmentStateTask.UpdateEquipmentStateTask;
     ...
     */
    public onBeforeSave(settings: UpdateEquipmentStateTask.UpdateEquipmentStateSettings):
            UpdateEquipmentStateTask.UpdateEquipmentStateSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [UpdateEquipmentStateSettings],
    defaultRoute: UpdateEquipmentStateSettings
})
export class UpdateEquipmentStateSettingsModule { }
