...
import { UpdateEquipmentStateSettings } from "./updateEquipmentState.task";
import {CustomEquipmentStateEnum} from "../../utilities/customEquipmentStateEnum"
@Task.Designer.TaskDesigner()
export class UpdateEquipmentStateDesigner implements Task.Designer.TaskDesignerInstance, UpdateEquipmentStateSettings {
