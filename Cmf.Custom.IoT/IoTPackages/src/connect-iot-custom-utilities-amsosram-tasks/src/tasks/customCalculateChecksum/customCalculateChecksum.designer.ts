...
import { CustomCalculateChecksumTask, CustomCalculateChecksumSettings, HashFunctions } from "./customCalculateChecksum.task";

@Task.Designer.TaskDesigner()
export class CustomCalculateChecksumDesigner implements Task.Designer.TaskDesignerInstance, CustomCalculateChecksumSettings {
