...
import { SlotMapValidatorSettings } from "./slotMapValidator.task";


@Task.Designer.TaskDesigner()
export class SlotMapValidatorDesigner implements Task.Designer.TaskDesignerInstance, SlotMapValidatorSettings {
    occupiedSlot: string;
    emptySlot: string;
    separator: string;
    fixedSize: boolean;
