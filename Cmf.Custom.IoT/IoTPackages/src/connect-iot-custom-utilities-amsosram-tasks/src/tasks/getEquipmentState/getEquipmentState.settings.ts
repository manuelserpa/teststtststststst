...
import * as GetEquipmentStateTask from "./getEquipmentState.task";
...
/** i18n */
import i18n from "./i18n/getEquipmentState.settings.default";

/** Constants */
export interface GetEquipmentStateTaskSettings extends GetEquipmentStateTask.GetEquipmentStateSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-getEquipmentState-settings",
    templateUrl: "getEquipmentState.settings.html",
    styleUrls: ["./getEquipmentState.settings.css"],
    assign: {
        i18n: i18n,
        EquipmentStateEnum: CustomEquipmentStateEnum
    }
})
export class GetEquipmentStateSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: GetEquipmentStateTaskSettings;
    private _taskInstance: GetEquipmentStateTask.GetEquipmentStateTask;
     ...
     */
    public onBeforeSave(settings: GetEquipmentStateTask.GetEquipmentStateSettings):
            GetEquipmentStateTask.GetEquipmentStateSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [GetEquipmentStateSettings],
    defaultRoute: GetEquipmentStateSettings
})
export class GetEquipmentStateSettingsModule { }
