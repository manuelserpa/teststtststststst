...
import { GetEquipmentStateSettings } from "./getEquipmentState.task";
import {CustomEquipmentStateEnum} from "../../utilities/customEquipmentStateEnum"
@Task.Designer.TaskDesigner()
export class GetEquipmentStateDesigner implements Task.Designer.TaskDesignerInstance, GetEquipmentStateSettings {
    [key: string]: any;
