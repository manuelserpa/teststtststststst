...
import * as CreateContainerTask from "./createContainer.task";
...
/** i18n */
import i18n from "./i18n/createContainer.settings.default";

/** Constants */
export interface CreateContainerTaskSettings extends CreateContainerTask.CreateContainerSettings, WorkflowModel.TaskDefinitionSettings {}
...
@Component({
    moduleId: module.id,
    selector: "connect-iot-controller-engine-core-tasks-createContainer-settings",
    templateUrl: "createContainer.settings.html",
    styleUrls: ["./createContainer.settings.css"],
    assign: {
        i18n: i18n
    }
})
export class CreateContainerSettings extends TaskSettingsBase implements ng.OnInit, ng.OnChanges {
     ...
     * Task settings
     */
    public settings: CreateContainerTaskSettings;
    private _taskInstance: CreateContainerTask.CreateContainerTask;
    ...
    public ngOnInit(): void {
        ...
        Object.assign(this.settings, CreateContainerTask.SETTINGS_DEFAULTS, currentSettings);
     ...
     */
    public onBeforeSave(settings: CreateContainerTask.CreateContainerSettings):
            CreateContainerTask.CreateContainerSettings {
        return settings;
    }
}
...
@Module({
    ...
    declarations: [CreateContainerSettings],
    defaultRoute: CreateContainerSettings
})
export class CreateContainerSettingsModule { }
