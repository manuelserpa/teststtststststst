...
import { CreateContainerSettings } from "./createContainer.task";

@Task.Designer.TaskDesigner()
export class CreateContainerDesigner implements Task.Designer.TaskDesignerInstance, CreateContainerSettings {
