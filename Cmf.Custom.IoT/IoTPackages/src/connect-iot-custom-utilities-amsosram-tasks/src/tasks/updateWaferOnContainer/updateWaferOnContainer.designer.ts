...
import { UpdateWaferOnContainerSettings } from "./updateWaferOnContainer.task";

@Task.Designer.TaskDesigner()
export class UpdateWaferOnContainerDesigner implements Task.Designer.TaskDesignerInstance, UpdateWaferOnContainerSettings {
